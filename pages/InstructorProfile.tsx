...
import { Star, PlayCircle, MessageSquare, Check } from 'lucide-react';
              ...
              <div className="flex flex-col sm:flex-row gap-8 items-start">
                ...
                <div className="flex-grow w-full">
                  <div className="flex justify-between items-start">
                    <div>
                      <h1 className="text-3xl font-bold text-gray-900 mb-2">{instructor.user.first_name} {instructor.user.last_name}</h1>
                      <p className="text-lg text-primary-600 font-medium mb-3">{instructor.headline}</p>
                    </div>
                    <div className="flex flex-col items-end bg-white/50 p-2 rounded-xl border border-white/60 backdrop-blur-sm">
                       <div className="flex items-center gap-1">
                        ...
                        <span className="text-xl font-bold text-gray-900">{instructor.rating}</span>
                      </div>
                      <span className="text-xs text-gray-500 font-semibold">{instructor.review_count} reviews</span>
                    </div>
                  </div>
            ...
            <div className="sticky top-28">
              <Card className="p-8 border-t-8 border-t-primary-500 shadow-2xl shadow-primary-900/5">
                <div className="text-center mb-8">
                  ...
                  <div className="text-5xl font-extrabold text-gray-900">${instructor.trial_price}</div>
                </div>
